...
buildGoModule {
  ...
  postInstall = ''
    install -Dm444 gf-completion.bash $out/share/bash-completion/completions/gf
    install -Dm444 gf-completion.fish $out/share/fish/vendor_completions.d/gf.fish
    install -Dm444 gf-completion.zsh $out/share/zsh/site-functions/_gf
  '';
